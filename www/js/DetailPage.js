...
currentPage.edit = function() {
	...
	if (name == "") {
		...
		$.ajax({
			type: "post",
			url: "http://localhost:8888/todolist-api/update_task.php",
			data: formData,
			dataType: "json",
...
function detailTask() {
	...
	$.ajax({
		type: "get",
		url: "http://localhost:8888/todolist-api/get_task_details.php",
		data: formData,
		dataType: "json",
		success: function(data) {
...
function deleteTask() {
	...
	$.ajax({
		type: "post",
		url: "http://localhost:8888/todolist-api/delete_task.php",
		data: formData,
		dataType: "json",
		success: function(data) {
